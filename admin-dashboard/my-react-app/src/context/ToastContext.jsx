...
export function ToastProvider({ children }) {
  ...
  return (
    <ToastContext.Provider value={{ toasts, success, error, warning, info, addToast, removeToast }}>
      {children}
      ...
      >
        {toasts.map((toast) => (
          ...
          >
            {icons[toast.type]}
            <p className="text-sm text-neutral-200 leading-snug flex-1">{toast.message}</p>
            <button
